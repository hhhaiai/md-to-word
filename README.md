...
🆕 **v2.3.0更新**（2025-07-24）：实现文档网格（版芯）设置，严格符合GB/T 9704-2012标准

## 功能特点

- ✅ 符合GB/T 9704-2012《党政机关公文格式》国家标准
- ✅ **文档网格（版芯）设置**：强制每页22行、每行28字
- ✅ **基于Pandoc引擎**，转换效果更专业
...
- **更新日期**：2025年7月24日
- **最新更新（v2.3.0）**：
  - **📐 实现文档网格（版芯）设置**：强制每页22行、每行28字
  - **🎯 严格符合GB/T 9704-2012标准**：所有文字锁定在网格内
  - **🚫 移除所有段前段后间距**：确保版面规范性
  - **📝 优化标题处理**：只处理一级和二级标题
  - **🔧 移除行距配置**：改用文档网格控制
- **v2.2.0更新**（2025-07-23）：
